            ...
            <table id="data_table" class="table table-bordered table-hover">
              ...
              <tbody>
                @if (count($users) > 0)
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="table-actions">
                          <a href="#" data-toggle="modal" data-target="#adminModal{{ $item->id }}" class="btn btn-sm bg-gradient-primary mr-1"><i class="fas fa-eye"></i></a>
                        </div>
                      </td>
                    </tr>
                    <!-- View Modal -->
                  ...
                  @endforeach
                @else
                  <td colspan="6" class="text-center">No Admins Found to Display!</td>
                @endif
              </tbody>
            </table>
          </div>
