                    ...
                    <tr>
                      ...
                      <td>
                        <div class="table-actions">
                          <a href="#" data-toggle="modal" data-target="#patientModal{{ $item->id }}" class="btn btn-sm bg-gradient-primary mr-1"><i class="fas fa-eye"></i></a>
                        </div>
                      </td>
                    </tr>
                    <!-- View Modal -->
                    @include('admin.patientlist.modal')
                  @endforeach
                @else
                  <td colspan="6" class="text-center">No Patients Found to Display!</td>
                @endif
              </tbody>
            </table>
          </div>
